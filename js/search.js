    ...
    <div id="u-search">
        <div class="modal">
            ...
            <form id="u-search-modal-form" class="u-search-form" name="uSearchModalForm">
                <input type="text" placeholder="Search..." id="u-search-modal-input" class="u-search-input" />
                <button type="button" id="u-search-modal-btn-submit" class="u-search-btn-submit">
            ...
            <footer class="modal-footer clearfix">
                ...
                <a class="nav btn-next modal-ajax-content">
                    <span class="text">NEXT</span> <span class="fa fa-chevron-right"></span>
                </a>
